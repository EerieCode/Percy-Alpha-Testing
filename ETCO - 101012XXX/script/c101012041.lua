...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,e,tp,c) end
...
function s.house_filter(c,e,tp)
	return c:IsCode(41232647) and c:IsCanBeSpecialSummoned(e,0,tp,false,true)
end
