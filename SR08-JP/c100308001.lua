...
function s.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_SPSUMMON+CATEGORY_DESTROY+CATEGORY_COUNTER)
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_SPSUMMON,c,1,0,0)
end
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 then
		local dc=Duel.GetMatchingGroupCount(aux.FaceupFilterFunction(Card.IsCanAddCounter,0x1,1,false,LOCATION_ONFIELD),tp,LOCATION_ONFIELD,0,nil)
