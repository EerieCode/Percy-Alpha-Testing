...
function c712559.initial_effect(c)
	...
	e1:SetCountLimit(1,100411103)
	e3:SetCondition(c100411003.spcon2)
	e1:SetTarget(c100411003.sptg2)
	e1:SetOperation(c100411003.spop2)
	c:RegisterEffect(e1)
end
...
function c100411003.sptg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c100411003.filter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
