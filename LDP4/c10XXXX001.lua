--Harpie Perfumer
function c10xxxx001.initial_effect(c)
	--search
...
c10xxxx001.listed_names={76812113,12206212}
function c10xxxx001.thfilter(c)
...
function c10xxxx001.thop(e,tp,eg,ep,ev,re,r,rp)
		...
		if g:GetCount()>0 and Duel.IsExistingMatchingCard(c7084129.filter,tp,LOCATION_MZONE,0,1,nil) and Duel.SelectYesNo(tp,210) then
			Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
