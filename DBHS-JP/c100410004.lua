...
function c100410004.initial_effect(c)
	...
	e1:SetOperation(c100410004.spr)
	c:RegisterEffect(e1)
...
function c100410004.filter(c,e,tp)
	return c:IsSetCard(0x219) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
	and  and Duel.IsExistingMatchingCard(aux.TRUE,tp,LOCATION_HAND,0,1,c)
end
...
function c100410004.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Destroy(g,REASON_EFFECT)~=0 then
		...
		local g2=Duel.SelectMatchingCard(tp,c2460565.filter,tp,LOCATION_HAND,0,1,1,nil,e,tp)
