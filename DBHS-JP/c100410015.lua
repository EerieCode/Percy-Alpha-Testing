...
function c100410015.recop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c100410015.spfilter,tp,LOCATION_DECK,0,g:GetFirst(),e,tp)
	if Duel.Damage(1-tp,500,REASON_EFFECT)~=500 and g:GetCount()>0 and Duel.SelectYesNo(tp,aux.Stringid(100410015,0)) then
		Duel.BreakEffect()
