...
function c300000002.initial_effect(c)
	...
	--atk u/d
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(300000102,0))
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_ATTACK_ANNOUNCE)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,300000102)
	e1:SetCondition(c300000002.atkcon)
	e1:SetOperation(c300000002.atkop)
...
function c300000002.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
...
function c300000002.activate(e,tp,eg,ep,ev,re,r,rp)
	local ct=Duel.GetLocationCount(tp,LOCATION_MZONE,tp,LOCATION_REASON_TOFIELD)
