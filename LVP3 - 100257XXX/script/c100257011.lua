...
function s.eqfilter(c,tp,oc)
	return (c:IsRace(oc:GetRace()) or c:IsAttribute(oc:GetAttribute())) and c:CheckUniqueOnField(tp) and c:IsType(TYPE_MONSTER) and not c:IsForbidden()
end
...
function s.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ec and s.equipop(tc,e,tp,ec) then
