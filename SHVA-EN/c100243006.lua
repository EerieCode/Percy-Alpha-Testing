...
function c100243006.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100243006,1))
...
c100243006.listed_names = {CARD_MISCHIEF_TIME}
...
function c100243006.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c100243006.filter,tp,LOCATION_HAND,0,1,ft,nil,e,tp)
	if #g>0 then
...
function c100243006.thfilter(c)
	return c:IsCode(CARD_MISCHIEF_TIME) and c:IsAbleToHand()
end
