...
function c101006042.descfilter2(c,g)
	return c:IsSetCard(0x55) and g:IsExists(Card.IsSetCard,1,c,0x7b)
end
function c101006042.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b2=g:IsExists(c101006042.descfilter2,1,nil,g)
	...
	if b1 and (not b2 or Duel.SelectYesNo(tp,aux.Stringid(101006042,2))) then
		...
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DISCARD)
		sg=g:FilterSelect(tp,c101006042.descfilter2,1,1,nil,g)
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DISCARD)
		sg=sg+g:FilterSelect(tp,Card.IsSetCard,1,1,sg,0x7b)
	end
