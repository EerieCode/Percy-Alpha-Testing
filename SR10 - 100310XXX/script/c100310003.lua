-- Machina Radiator - マシンナーズ・ラディエータ
local s,id=GetID()
...
function s.spop2(e,tp,eg,ep,ev,re,r,rp)
	...
	local sc=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp,tc)
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(sc,0,tp,tp,false,false,POS_FACEUP)~=0 and tc:IsRelateToEffect(e) then
