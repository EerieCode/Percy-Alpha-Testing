...
function c101007019.initial_effect(c)
	...
	e2:SetTarget(c101007019.atktg)
	e2:SetOperation(c101007019.atkop)
	c:RegisterEffect(e2)
end
...
function c101007019.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsPlayerCanDraw(tp,1) end
	Duel.SetOperationInfo(0,CATEGORY_HANDES,nil,0,tp,1)
	Duel.SetOperationInfo(0,CATEGORY_DRAW,nil,0,tp,1)
end
function c101007019.atkop1(e,tp,eg,ep,ev,re,r,rp,chk)
