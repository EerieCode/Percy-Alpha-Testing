...
function c101007077.initial_effect(c)
	...
	e1:SetCountLimit(1,101007077+EFFECT_COUNT_CODE_SINGLE+EFFECT_COUNT_CODE_OATH)
	...
	e2:SetCountLimit(1,101007077+EFFECT_COUNT_CODE_SINGLE+EFFECT_COUNT_CODE_OATH)
