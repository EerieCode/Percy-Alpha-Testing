...
function c101007035.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcMix(c,true,true,89943723,c101007035.ffilter)
	--spsummon condition
...
c101007035.listed_names={89943723}
function c101007035.ffilter(c,fc,sumtype,tp)
	return c:IsType(TYPE_EFFECT,fc,sumtype,tp) and c:GetLevel()<=4
end
