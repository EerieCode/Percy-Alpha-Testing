...
function c101005043.initial_effect(c)
	...
	--Search
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(101005043,0))
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetCode(EVENT_SPSUMMON_SUCCESS)
	e1:SetCountLimit(1,101005043)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCondition(c101005043.thcon)
	e1:SetTarget(c101005043.thtg)
	e1:SetOperation(c101005043.thop)
	c:RegisterEffect(e1)
