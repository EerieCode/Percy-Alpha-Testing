...
--Dark Magician Bear - hangs on resolution
...
Debug.AddCard(512000129,0,0,LOCATION_SZONE,1,POS_FACEDOWN)]]
...
--Ultimate Battle Formation of Despair - doesn't special summon after selecting
...
--Scarf-kun - will write test later

--Mischief of the Incomplete Goddess - works? hard to tell in a way that doesn't matter
...
--Banlist Predictions - announcing cards doesn't let you select any after 2
